...
public interface AppraisalRepository extends JpaRepository<Appraisal, Long> {
    ...
    List<Appraisal> findByDepartmentAndStatus(@Param("department") User.Department department, @Param("status") Appraisal.AppraisalStatus status);
    ...
    List<Appraisal> findByDepartmentAndPeriod(@Param("department") User.Department department, @Param("period") String period);
    ...
    long countByDepartmentAndStatus(@Param("department") User.Department department, @Param("status") Appraisal.AppraisalStatus status);
    ...
    List<Appraisal> findByYearAndDepartment(@Param("year") String year, @Param("department") User.Department department);
