...
public interface PerformanceManagementService {
    ...
    // Feedback Requests
    FeedbackRequestDto createFeedbackRequest(FeedbackRequestDto requestDto, User currentUser);

    FeedbackRequestDto updateFeedbackRequestStatus(Long requestId, String status, User currentUser);

    List<FeedbackRequestDto> getFeedbackRequestsForUser(User currentUser);

    List<FeedbackRequestDto> getFeedbackRequestsFromUser(User currentUser);

    List<FeedbackRequestDto> getPendingFeedbackRequests(User currentUser);
    ...
    List<AppraisalDto> getEditableAppraisalsByEmployee(Long employeeId, User currentUser);

    // Rating trends for a single employee (completed appraisals only)
    List<RatingTrendPointDto> getRatingTrendsByEmployee(Long employeeId, User currentUser);
