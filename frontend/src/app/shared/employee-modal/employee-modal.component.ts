          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <div class="error-message" *ngIf="employeeForm.get('phoneNumber')?.invalid && employeeForm.get('phoneNumber')?.touched">
                <span *ngIf="employeeForm.get('phoneNumber')?.errors?.['required']">Phone number is required</span>
                <span *ngIf="employeeForm.get('phoneNumber')?.errors?.['pattern']">Phone number can only contain numbers, +, -, spaces, and ()</span>
                <span *ngIf="employeeForm.get('phoneNumber')?.errors?.['minlength']">Phone number must be at least 10 digits</span>
              </div>
            </div>
          </div>
...
export class EmployeeModalComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder) {
    this.employeeForm = this.fb.group({
      ...
      phoneNumber: ['', [Validators.required, Validators.pattern(/^[0-9+\-\s()]+$/), Validators.minLength(10)]],
  ...
  onPhoneNumberKeyPress(event: KeyboardEvent): void {
    // Allow only numbers, +, -, spaces, (, ), backspace, delete, tab, escape, enter
  ...
  onPhoneNumberInput(event: Event): void {
    ...
    // Remove any characters that are not numbers, +, -, spaces, (, )
    value = value.replace(/[^0-9+\-\s()]/g, '');
    
    // Update the form control value
    this.employeeForm.patchValue({ phoneNumber: value });
  }
} 